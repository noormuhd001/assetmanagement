                            ...
                            <tbody>
                                @foreach ($asset as $assets)
                                    <tr>
                                        ...
                                        <td>{{ $assets->model }}</td>
                                        <td><a
                                                href="{{ route('addasset', ['id' => $user->id, 'assetid' => $assets->id]) }}"><button
                                                    class="btn btn-outline-primary">Add</button></a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                @foreach ($assetadded as $assetaddeds)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('removeasset', ['id' => $assetaddeds->id]) }}"><button
